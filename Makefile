...
KBUILD_AFLAGS   := -D__ASSEMBLY__ -fno-PIE -fPIC
KBUILD_CFLAGS   := -Wall -Wundef -Wno-strict-prototypes -Wno-trigraphs -pipe -fPIC\
		   -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE \
		   -Wno-implicit-function-declaration -Wno-error=implicit-int \
